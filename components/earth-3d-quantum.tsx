...
console.log("[v0] Earth 3D Quantum component loaded")
...
function EnhancedEarth({
  ...
  const earthTexture = useLoader(
    TextureLoader,
    "/realistic-earth-texture-with-blue-oceans-and-green.jpg",
    undefined,
    (error) => {
      console.error("[v0] Failed to load Earth texture:", error)
    },
  )

  console.log("[v0] Earth texture loaded:", earthTexture ? "success" : "failed")
...
export default function EnhancedEarth3D() {
  console.log("[v0] EnhancedEarth3D component rendering")
  ...
  useEffect(() => {
    console.log("[v0] Setting client ready")
    setClientReady(true)
                ...
                <CardContent>
                  <div className="text-center py-4">
                    <div className="w-16 h-16 mx-auto mb-4 relative">
                      <div className="absolute inset-0 bg-primary/20 rounded-full animate-spin" />
